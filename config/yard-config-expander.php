...
return [
	...
	'licenses' => [
		...
		'GRAVITYSMTP_GENERIC_FORCE_FROM_EMAIL' => $_SERVER['GRAVITYSMTP_GENERIC_FORCE_FROM_EMAIL'] ?? null,
		'GRAVITYSMTP_GENERIC_PASSWORD' => $_SERVER['GRAVITYSMTP_GENERIC_PASSWORD'] ?? null,
