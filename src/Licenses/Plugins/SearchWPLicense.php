...
class SearchWPLicense extends AbstractLicense
{
	protected const LICENSE_CONFIG_KEY = 'SEARCHWP_LICENSE_KEY';
	protected const PLUGIN_LICENSE_CONSTANT = 'SEARCHWP_LICENSE_KEY';
